...
function Admin() {
  ...
  return (
    <div
      className="admin_page flex flex-col w-full items-center justify-center  rounded-lg bg-center "
      style={{ backgroundColor: "#E6F0FF", minHeight: "100vh" }}
    >
      ...
      <div className=" flex items-center py-16 pr-20 pl-20 rounded-lg  justify-center flex-col  w-full">
        <h1 className=" text-center  text-2xl  font-semibold text-yellow-600">
          {" "}
          Lancer la récupération d'annonce
        </h1>
        <div className="other-component mt-6 rounded-lg  ">
          <div id="onglets" className="p-5 mt-6 ">
            <div
              id="cree"
              className={`onglet_cree ${
                stateOnglets === 1 ? "active" : ""
              } hover:bg-gray-200 rounded-lg cursor-pointer text-black py-2 px-2  text-lg items-center`}
              onClick={scrappe1}
            >
              site 1 : Annonce Algerie
            </div>
            <div
              id="save"
              className={`onglet_save ${
          ...
          {stateOnglets === 1 ? (
            <div>
              <div className="ml-10 mr-10  mb-10    p-16 rounded-lg">
                <h3 className="text-center font-Montserrat text-sky-900 mb-6 text-base  font-extrabold">
                  site : AnnonceAlgerie
                </h3>
                ...
                <div className="  flex flex-col items-center text-base font-lg  justify-between mt-9 ">
                  <div>
                    <h3
                      className="m-3  p-2  text-base font-bold text-sky-600"
                      id="myH3"
                    >
                      {" "}
                      {load1
                        ? "récuperation d'annonce et fait avec succès"
                        : " "}{" "}
                    </h3>
                  </div>
                  ...
                  return (
                    !m.UserType && (
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">{m.numeroDeTelephone}</td>
                        <td class="px-6 py-4">{m.adresse}</td>
                      </tr>
                    )
                  );
                })}
